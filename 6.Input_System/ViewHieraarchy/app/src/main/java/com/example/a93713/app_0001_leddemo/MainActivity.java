...
//    private  ILedService iLedService = null;
    ...
    public void printViewHierarchy(View parent, int level, int childidx) {
        /*
         * * DecorView child -1 (x, y)
         *      ** FrameLayout child 0 (x, y)
         *              *** TextView child 0 (x, y)
         *      ** FrameLayout child 1 (x, y)
         *              *** Button child 0 (x, y)
         *              *** TextView child 1 (x, y)
         *              *** FrameLayout child 2 (x, y)
         * */
        int i;
        String levelStr = "*";
        for (i = 0;i < level; i++)
        ...
        Log.d(TAG, levelStr + " " + parent.getClass().getName() + " child " + childidx + " (" + positions[0] +", " + positions[1] + ")");
    ...
    class MyButtonListener implements View.OnClickListener{
        public void onClick(View v) {
            View decocView = getWindow().getDecorView();
