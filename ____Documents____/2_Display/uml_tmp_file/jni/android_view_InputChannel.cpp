...
static jlong android_view_InputChannel_nativeGetFd(JNIEnv* env, jobject obj) {
    NativeInputChannel* nativeInputChannel =
            android_view_InputChannel_getNativeInputChannel(env, obj);
    if (! nativeInputChannel) {
        return -1;
    ...
    return nativeInputChannel->getInputChannel()->getFd();
}
...
static JNINativeMethod gInputChannelMethods[] = {
	...
	{ "nativeGetFd",
			"()J",
			(void*) android_view_InputChannel_nativeGetFd },
};
